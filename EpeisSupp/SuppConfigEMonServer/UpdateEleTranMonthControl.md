## 1、接口描述  
服务接口：(UpdateEleTranMonthControl)修改电翻转月份信息  
接口描述：修改电翻转月份信息  
请求说明：POST https://api.epeis.com/SuppConfigEMonServer/v1/UpdateEleTranMonthControl  
...
| PAYMENT_DATE_TYPE |  是  | String   | 2 | 0 | 结账出账例日 |  
