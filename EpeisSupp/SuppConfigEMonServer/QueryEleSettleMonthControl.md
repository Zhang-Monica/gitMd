## 1、接口描述  
服务接口：(QueryEleSettleMonthControl)查询电结账月份控制信息  
接口描述：查询电结账月份控制信息  
请求说明：POST https://api.epeis.com/SuppConfigEMonServer/v1/QueryEleSettleMonthControl  
...
| SETTLE_ACCOUNT_MONTH |  否  | Number   | 结账月份 |  
