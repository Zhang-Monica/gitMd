## 1、接口描述  
服务接口：(QueryPrintInvoiceInfo)查询发票信息  
接口描述：查询发票信息  
请求说明：POST https://api.epeis.com/Service/v1/QueryPrintInvoiceInfo/  
...
| INPUT_YESNO |  是  | String   | 是否缴费：1-否，2-是 |  
