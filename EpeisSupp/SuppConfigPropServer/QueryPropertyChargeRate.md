## 1、接口描述  
服务接口：(QueryPropertyChargeRate)查询物业计费比例  
接口描述：查询物业计费比例  
请求说明：POST https://api.epeis.com/SuppConfigPropServer/v1/QueryPropertyChargeRate  
...
| STOP_EMPTY_YESNO |  否  | String   | 是否停/空：1-否2-是 |  
