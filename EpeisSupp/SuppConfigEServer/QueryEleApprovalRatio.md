## 1、接口描述  
服务接口：(QueryEleApprovalRatio)查询电核定最大需量调节比例  
接口描述：查询电核定最大需量调节比例  
请求说明：POST https://api.epeis.com/SuppConfigEServer/v1/QueryEleApprovalRatio  
...
| OVER_APPROVAL_RATIO |  否  | Number   | 超出核定比例，精确到4位小数点 |  
| APPROVAL_FACTOR |  否  | Number   | 核定系数，精确到4位小数点 |  
