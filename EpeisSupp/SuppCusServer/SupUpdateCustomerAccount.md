## 1、接口描述  
服务接口：(SupUpdateCustomerAccount)商户端客户账户信息变更  
接口描述：商户端客户账户信息变更  
请求说明：POST https://api.epeis.com/Service/v1/SupUpdateCustomerAccount/  
...
| 参数              | 必选 | 类型     | 长度 | 精度 | 描述             |  
| :----------------- | :----: | :-------- | :----: | :----: | :---------------- |  
| CUSTOMER_DID |  是  | String   | 16 | 0 | 客户账户 |  
...
| CUS_ATTESTATION_TYPE |  是  | String   | 客户认证类型：1-未认证；2-审核中；3-已认证 |  
